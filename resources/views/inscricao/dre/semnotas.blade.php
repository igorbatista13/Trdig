...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>LISTA DE INSCRITOS - Etapa 2 -  Não Avaliados pela DRE</h1>
    <nav>
      <ol class="breadcrumb">
          ...
          <div class="card-body">
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <td><b> {{$recibos->Nome ?? 'Não informado'}} </b><p><small class="text-muted"> {{$recibos->cpf ?? 'Não informado'}} | {{$recibos->cidade->Nome ?? 'Não informado'}} - {{$recibos->dre->Nome ?? 'Não informado'}} </small></td>
