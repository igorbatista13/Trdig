        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active ">Minha Caixa de Entrada</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Minha Caixa de Entrada</h5>
                            ...
                            <table class="table datatable">
                                ...
                                @foreach ($nProcessos as $n_processo)
                                    ...
                                    <td> <small> <b> <img src="{{ asset('images/brasao_mt.png') }}" width="20px">
                                                {{ $n_processo->Orgaos->Sigla ?? 'Não informado' }} </b> - <i>
                                    ...
                                    <td>
                                        @switch($n_processo)
                                            @case($n_processo->Status == '' || $n_processo->Status == 'TRAMITADO')
                                                <div class="dropdown">
                                                    <center> <a class="btn btn-dark dropdown-toggle" href="#" role="button"
                                            ...
                                            @case($n_processo->Status == 'CORRIGIR')
                                                ...
                                                <div class="dropdown">
                                                    <center> <a class="btn btn-warning btn-sm" href="#" role="button"
                                                        ...
                                                        <br>
                                                        <small class="text-a btn btn-danger btn-sm"> Aguardando a correção pelo proponente </small>
                                            ...
                                            @case ($n_processo->Status == 'FINALIZADO')
                                                <div class="dropdown">
                                                    <center> <a class="btn btn-success btn-sm " href="#" role="button"
                                                            id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi bi-check-circle me-1"> <span>
                            ...
                            <td>
                                ...
                                @else
                                    <a button type="button" class="btn btn-success disabled" 
                                        href="{{ asset('trdigital/validar/' . $n_processo->id) }}" >
                                        <i class="bi bi-ui-checks me-1"> </i>
                                    </a>
                                @endif
                            ...
                            <td> 
                                ...
                                @else
                                <a button type="button" class="btn btn-outline-success disabled"
                                    href="{{ asset('trdigital/imprimir/' . $n_processo->id) }}">
                                    <i class="bi bi-printer-fill me-1"> </i>
                                </a>
